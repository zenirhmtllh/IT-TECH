					...
					<div class="row" style="margin-left: -10%;margin-right: -10%">
						...
						<div class="col-3" style="">
							<div class="card" style="width: 200px;margin-top: 10px; background:  linear-gradient(315deg, #f6f0c4 0%, #d99ec9 74%);border-radius: 20px;">
								<center>
							  <img src="<?php echo 'foto_produk/'. $perproduk ['foto'] ?>" " class="card-img-top" alt="..." style="width: 100%;height:100%;padding: 10%;border-radius: 40px">
								</center>
							  <div class="card-body">
								<h5 class="card-title"><?php echo $perproduk ['produkname'] ?></h5>
								<p class="card-text" style="margin: auto;"><i class="icon"><img src="seller.png" style="padding-right: 3px"></i><?php echo $perproduk ['seller'] ?></p>
								<p class="card-text" style="margin: auto;"><i class="icon"><img src="price.png" style="padding-right: 3px;"></i>Rp.
								<?php echo number_format ($perproduk ['price']) ?></p>
								<p class="card-text"><i class="icon"><img src="location.png" style="padding-right: 3px;"></i><?php echo $perproduk ['lokasi'] ?></p>
                                <center>
								<a href="beli.php?id=<?php echo $perproduk ['id'] ?>" class="btn btn-primary" style="width: 95%;background: #E09B9B;
								border-radius: 10px; border: none;">beli</a>

								<a href="detail.php?id=<?php echo $perproduk ['id'] ?>" class="btn btn-primary" style="width: 95%;background: #E09B9B;
								border-radius: 10px; border: none; margin-top:10px;">details</a>
								</center>
