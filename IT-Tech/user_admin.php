  ...
  <div class="collapse navbar-collapse" id="navbarNav" style="padding-left:5%;">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="#" style="font-size: 25px;">User<span class="sr-only">(current)</span></a>
      </li>
    </ul>
			...
			<div class="col-10">
				...
				<table  class="table">
					...
					<tbody>
						<?php $nomor=1;?>
						<?php
						$datu = $koneksi->query("SELECT * FROM data");
						while($datauser = $datu-> fetch_assoc()){
						?>
						<tr>
							...
							<td><a href="hapus_akun.php?id=<?php echo $datauser['id_user']?>" class="btn btn-danger btn-xs">hapus</a></td>
						</tr>
						<?php $nomor++;?>
                        <?php } ?>
						</tbody>
