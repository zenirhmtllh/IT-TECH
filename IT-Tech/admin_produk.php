			...
			<div class="col-10">
				...
				<table  class="table">
					...
					<tbody>
						<?php $nomor=1;?>
						<?php
						$datp = $koneksi->query("SELECT * FROM produk");
						while($dataproduk = $datp-> fetch_assoc()){
						?>
						<tr>
							<td><?php echo $nomor;?></td>
							<td><?php echo $dataproduk["id"];?></td>
							<td><?php echo $dataproduk["produkname"];?></td>
							<td><?php echo $dataproduk["seller"];?></td>
							<td>Rp.<?php echo number_format($dataproduk["price"]);?></td>
                            <td><?php echo $dataproduk["stok_produk"];?></td>
                            <td><?php echo $dataproduk["lokasi"];?></td>
                            <td><?php echo $dataproduk["description"];?></td>
						</tr>
						<?php $nomor++;?>
                        <?php } ?>
						</tbody>
