...
<body class="back">
  ...
  <div class="collapse navbar-collapse" id="navbarNav" style="padding-left:5%;">
	...
	<div class="container" style="margin-top: 54px;">
		...
		<!--content-->
			<?php $ambil=mysqli_query($koneksi,"SELECT * FROM produk where id_user='$_SESSION[id_user]'");?>
			<div class="col-10" style="margin-left: 300px;">
				<div class="container py-4 my-2">
				<div class="row">
				<div class="col-9" style="">
				<form action="" method="post" style="justify-content: center">
				<table class="table" style="background: whitesmoke; border-radius:10px; width:auto;">
					...
					while($produk = $ambil->fetch_assoc()){?>
					 <tr>
						...
						<td><?php echo $produk["price"];?></td>
						 ...
						 <td><?php echo $produk["seller"];?></td>
						 <td><?php echo $produk["lokasi"];?></td>
						 <td><img class="w-100 rounded border" style="width: 30px; height: 30px" src="<?php echo 'foto_produk/'. $produk ['foto'] ?>" /></td>
						<td><a href="prosesdel.php?id=<?php echo $produk['id']; ?>">Delete</a> </td>
						 <td><a href="editprdk.php?id=<?php echo $produk['id']; ?>">Update</a></td>
					</tr>
					<?php $no++; } ?>
					<?php } ?>
					</table>
