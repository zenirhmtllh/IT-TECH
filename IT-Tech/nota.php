	...
	<div class="container" style="margin-top: 54px;">
		<div class="row">
            ...
            <div class="col-10" style="margin-left: 300px;">
                ...
                <a style="margin-top:10px; margin-bottom:15px"href="landing.php?id=<?php echo $_SESSION['id_user'];?>" class="btn btn-primary">Halaman utama</a>
                <a style="margin-top:10px; margin-bottom:15px" href="riwayat_pembelian.php?id=<?php echo $_SESSION['id_user'];?>" class="btn btn-primary">kembali</a>
                </div>
                </div>
                </div>
                </div>